//common values
region           = "us-west-2"
aws_account_name = "PRD"

//EKS Modul
cluster_name                          = "KF-USW2-PRD"
...
kube_prometheus_domain_name   = "kf.us.aa.<team>.<company>.com"
// Ingress Nginx
...
splunk_connect_logging_index_name = "prd-k8s-logs"
splunk_connect_metrix_index_name  = "prd-k8s-metrics"
//NFS Provisioner
...
s3_bucket                         = "s3-usw2-kf-assets-01"
